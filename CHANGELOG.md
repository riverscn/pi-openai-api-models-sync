...
## [0.3.3](https://github.com/riverscn/pi-openai-api-models-sync/compare/v0.3.2...v0.3.3) (2026-09-11)


### Bug Fixes

* resolve model sync paths from the active Pi environment ([#2](https://github.com/riverscn/pi-openai-api-models-sync/issues/2)) ([d4a30a1](https://github.com/riverscn/pi-openai-api-models-sync/commit/d4a30a105e14e17615cf3a16e1e6dacc5cd2b0e3))
